...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
             ...
             xmlns:tng="java:org.opengis.cite.ogcapiprocesses120.TestNGController">
  ...
  <ctl:function name="tns:run-ets-${ets-code}">
    ...
    <ctl:description>Runs the OGC API - Pprocesses Part 1 and Part 2 (${version}) test suite.</ctl:description>
    <ctl:code>
      ...
      <xsl:variable name="form-data">
        <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
          ...
          <div style="background:#F0F8FF" bgcolor="#F0F8FF">
            ...
            <p>The following conformance levels are defined for Part 1:</p>
            <ul>
              <li>Core</li>
            ...
            <p>The following conformance levels are defined for Part 2:</p>
            <ul>
